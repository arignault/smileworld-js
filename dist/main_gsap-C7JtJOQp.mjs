...
var nt = {
  ...
  overwrite: !1,
  delay: 0
}, hi, X, R, ut = 1e8, P = 1 / ut, $e = Math.PI * 2, rn = $e / 4, nn = 0, tr = Math.sqrt, sn = Math.cos, on = Math.sin, G = function(t) {
...
}, j = Array.isArray, je = /(?:-?\.?\d|\.)+/gi, ir = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, Xt = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, qe = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, rr = /[+-]=-?[.\d]+/, nr = /[^,'"\[\]\s]+/gi, an = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, I, ht, Ke, pi, st = {}, Ce = {}, sr, or = function(t) {
  return (Ce = Qt(t, st)) && tt;
}, mi = function(t, e) {
  return console.warn("Invalid property", t, "set to", e, "Missing plugin? gsap.registerPlugin()");
}, he = function(t, e) {
  return !e && console.warn(t);
}, ar = function(t, e) {
  return t && (st[t] = e) && Ce && (Ce[t] = e) || st;
}, _e = function() {
  return 0;
}, un = {
  suppressEvents: !0,
  ...
  suppressEvents: !0
}, gi = {}, Ot = [], He = {}, ur, et = {}, Ne = {}, Li = 30, ke = [], yi = "", vi = function(t) {
  var e = t[0], i, r;
  ...
  var e = t.parent || I, i = t.keyframes ? fn(j(t.keyframes)) : ot;
  if (H(t.inherit))
    for (; e; )
  ...
  return e.parent && Et(e), e._start = U((bt(i) ? i : i || t !== I ? at(t, i, e) : t._time) + e._delay), e._end = U(e._start + (e.totalDuration() / Math.abs(e.timeScale()) || 0)), _r(t, e, "_first", "_last", t._sort ? "_start" : 0), Qe(e) || (t._recent = e), r || dr(t, e), t._ts < 0 && ze(t, t._tTime), t;
}, pr = function(t, e) {
  return (st.ScrollTrigger || mi("scrollTrigger", e)) && st.ScrollTrigger.create(e, t);
}, mr = function(t, e, i, r, n) {
  if (xi(t, e, n), !t._initted)
    return 1;
  if (!i && t._pt && !X && (t._dur && t.vars.lazy !== !1 || !t._dur && t.vars.lazy) && ur !== it.frame)
  ...
  var n = t.ratio, s = e < 0 || !e && (!t._start && pn(t) && !(!t._initted && Qe(t)) || (t._ts < 0 || t._dp._ts < 0) && !Qe(t)) ? 0 : 1, a = t._rDelay, u = 0, l, c, h;
  ...
  var r = t.labels, n = t._recent || yn, s = t.duration() >= ut ? n.endTime(!1) : t._dur, a, u, l;
  ...
  var r = bt(e[1]), n = (r ? 2 : 1) + (t < 2 ? 0 : 1), s = e[n], a, u;
  ...
  return !G(t) || !(e = an.exec(t)) ? "" : e[1];
}, vn = function(t, e, i) {
  return Dt(i, function(r) {
    return we(t, e, r);
  });
}, Je = [].slice, gr = function(t, e) {
  return t && mt(t) && "length" in t && (!e && !t.length || t.length - 1 in t && mt(t[0])) && !t.nodeType && t !== ht;
}, wn = function(t, e, i) {
  return i === void 0 && (i = []), t.forEach(function(r) {
    var n;
    return G(r) && !e || gr(r, 1) ? (n = i).push.apply(n, lt(r)) : i.push(r);
  }) || i;
}, lt = function(t, e, i) {
  return R && !e && R.selector ? R.selector(t) : G(t) && !i && (Ke || !ee()) ? Je.call((e || pi).querySelectorAll(t), 0) : j(t) ? wn(t, i) : gr(t) ? Je.call(t, 0) : t ? [t] : [];
}, ti = function(t) {
  ...
  return G(r) ? c = h = {
    ...
    var f = (p || e).length, m = s[f], y, v, w, b, g, T, S, k, x;
    if (!m) {
      if (x = e.grid === "auto" ? 0 : (e.grid || [1, ut])[1], !x) {
        for (S = -ut; S < (S = p[x++].getBoundingClientRect().left) && x < f; )
          ;
        x < f && x--;
      }
      for (m = s[f] = [], y = u ? Math.min(x, f) * c - 0.5 : r % x, v = x === ut ? 0 : u ? f * h / x - 0.5 : r / x | 0, S = 0, k = ut, T = 0; T < f; T++)
        w = T % x - y, b = v - (T / x | 0), m[T] = g = l ? Math.abs(l === "y" ? b : w) : tr(w * w + b * b), g > S && (S = g), g < k && (k = g);
      r === "random" && yr(m), m.max = S - k, m.min = k, m.v = f = (parseFloat(e.amount) || parseFloat(e.each) * (x > f ? f - 1 : l ? l === "y" ? f / x : x : Math.max(x, f / x)) || 0) * (r === "edges" ? -1 : 1), m.b = f < 0 ? n - f : n, m.u = $(e.amount || e.each) || 0, i = i && f < 0 ? Pr(i) : i;
    }
  ...
  var i = j(t), r, n;
  return !i && mt(t) && (r = i = t.radius || ut, t.values ? (t = lt(t.values), (n = !bt(t[0])) && (r *= r)) : t = ei(t.increment)), Dt(e, i ? z(t) ? function(s) {
    ...
    return c = !r || l <= r ? t[c] : s, n || c === s || bt(s) ? c : c + $(s);
  } : ei(t));
}, br = function(t, e, i, r) {
  ...
  for (var e = 0, i = "", r, n, s, a; ~(r = t.indexOf("random(", e)); )
    s = t.indexOf(")", r), a = t.charAt(r + 7) === "[", n = t.substr(r + 7, s - r - 7).match(a ? nr : je), i += t.substr(e, r - e) + br(a ? n : +n[0], a ? 0 : +n[1], +n[2] || 1e-5), e = s + 1;
  ...
  if (t)
    if (t = !t.name && t.default || t, di() || t.headless) {
      ...
      ar(e, r), t.register && t.register(tt, r, Q);
    } else
      Sr.push(t);
}, C = 255, ae = {
  aqua: [0, C, C],
  ...
  var r = t ? bt(t) ? [t >> 16, t >> 8 & C, t & C] : 0 : ae.black, n, s, a, u, l, c, h, _, d, p;
  if (!r) {
    if (t.substr(-1) === "," && (t = t.substr(0, t.length - 1)), ae[t])
      ...
      if (r = p = t.match(je), !e)
        ...
        return r = t.match(ir), i && r.length < 4 && (r[3] = 1), r;
    } else
      r = t.match(je) || ae.transparent;
    r = r.map(Number);
  }
  return e && !p && (n = r[0] / C, s = r[1] / C, a = r[2] / C, h = Math.max(n, s, a), _ = Math.min(n, s, a), c = (h + _) / 2, h === _ ? u = l = 0 : (d = h - _, l = c > 0.5 ? d / (2 - h - _) : d / (h + _), u = h === n ? (s - a) / d + (s < a ? 6 : 0) : h === s ? (a - n) / d + 2 : (n - s) / d + 4, u *= 60), r[0] = ~~(u + 0.5), r[1] = ~~(l * 100 + 0.5), r[2] = ~~(c * 100 + 0.5)), i && r.length < 4 && (r[3] = 1), r;
}, Mr = function(t) {
  var e = [], i = [], r = -1;
  ...
  }), i && (c = Mr(t), u = i.c, u.join(r) !== c.c.join(r)))
    for (l = t.replace(Mt, "1").split(Xt), h = l.length - 1; a < h; a++)
...
}(), Mn = /hsl[a]?\(/, Cr = function(t) {
  var e = t.join(" "), i;
  if (Mt.lastIndex = 0, Mt.test(e))
    return i = Mn.test(e), t[1] = Ni(t[1], i), t[0] = Ni(t[0], i, Mr(t[1])), !0;
}, pe, it = function() {
  var o = Date.now, t = 500, e = 33, i = o(), r = i, n = 1e3 / 240, s = n, a = [], u, l, c, h, _, d, p = function f(m) {
    var y = o() - r, v = m === !0, w, b, g, T;
    if ((y > t || y < 0) && (i += y - e), r += y, g = r - i, w = g - s, (w > 0 || v) && (T = ++h.frame, _ = g - h.time * 1e3, h.time = g = g / 1e3, s += w + (w >= n ? 4 : n - w), b = 1), v || (u = l(f)), b)
  ...
  return h = {
    ...
    wake: function() {
      sr && (!Ke && di() && (ht = Ke = window, pi = ht.document || {}, st.gsap = tt, (ht.gsapVersions || (ht.gsapVersions = [])).push(tt.version), or(Ce || ht.GreenSockGlobals || !ht.gsap && ht || {}), Sr.forEach(kr)), c = typeof requestAnimationFrame < "u" && requestAnimationFrame, u && h.sleep(), l = c || function(m) {
    ...
    add: function(m, y, v) {
      var w = y ? function(b, g, T, S) {
        m(b, g, T, S), h.remove(w);
      } : m;
  ...
  return !pe && it.wake();
}, O = {}, Cn = /^[\d.\-M][\d.\-,\s]/, Pn = /["']/g, En = function(t) {
  for (var e = {}, i = t.substr(1, t.length - 3).split(":"), r = i[0], n = 1, s = i.length, a, u, l; n < s; n++)
    u = i[n], a = n !== s - 1 ? u.lastIndexOf(",") : u.length, l = u.substr(0, a), e[r] = isNaN(l) ? l.replace(Pn, "").trim() : +l, r = u.substr(a + 1).trim();
  return e;
}, An = function(t) {
  ...
  return i && e.length > 1 && i.config ? i.config.apply(null, ~t.indexOf("{") ? [En(e[1])] : An(t).split(",").map(fr)) : O._CE && Cn.test(t) ? O._CE("", t) : i;
}, Pr = function(t) {
  return function(e) {
    return 1 - t(1 - e);
  };
  ...
  var r = e >= 1 ? e : 1, n = (i || (t ? 0.3 : 0.45)) / (e < 1 ? e : 1), s = n / $e * (Math.asin(1 / r) || 0), a = function(c) {
    return c === 1 ? 1 : r * Math.pow(2, -10 * c) * on((c - s) * n) + 1;
...
var Dr = function(t, e) {
  this.id = nn++, t._gsap = this, this.target = t, this.harness = e, this.get = e ? e.get : lr, this.set = e ? e.getSetter : Si;
  ...
  return t.delay = function(i) {
    ...
    if (n && n.smoothChildTiming && this._ts) {
      for (ze(this, i), !n._dp || n.parent || dr(n, this); n && n.parent; )
    ...
    return (this._tTime !== i || !this._dur && !r || this._initted && Math.abs(this._zTime) === P || !i && !this._initted && (this.add || this._ptLookup)) && (this._ts || (this._pTime = i), cr(this, i, r)), this;
  }, t.time = function(i, r) {
    ...
    return this._rts = +i || 0, this._ts = this._ps || i === -P ? 0 : this._rts, this.totalTime(we(-Math.abs(this._delay), this.totalDuration(), n), r !== !1), Fe(this), _n(this);
  }, t.paused = function(i) {
...
var K = /* @__PURE__ */ function(o) {
  ...
  function t(i, r) {
    var n;
    return i === void 0 && (i = {}), n = o.call(this, i) || this, n.labels = {}, n.smoothChildTiming = !!i.smoothChildTiming, n.autoRemoveChildren = !!i.autoRemoveChildren, n._sort = H(i.sortChildren), I && dt(i.parent || I, yt(n), r), i.reversed && n.reverse(), i.paused && n.paused(!0), i.scrollTrigger && pr(yt(n), i.scrollTrigger), n;
  }
  var e = t.prototype;
  return e.to = function(r, n, s) {
    ...
    var a = this._time, u = this._dirty ? this.totalDuration() : this._tDur, l = this._dur, c = r <= 0 ? 0 : U(r), h = this._zTime < 0 != r < 0 && (this._initted || !l), _, d, p, f, m, y, v, w, b, g, T, S;
    if (this !== I && c > u && r >= 0 && (c = u), c !== this._tTime || s || h) {
      if (a !== this._time && l && (c += this._time - a, r += this._time - a), _ = c, b = this._start, w = this._ts, y = !w, h && (l || (a = this._zTime), (r || !n) && (this._zTime = r)), this._repeat) {
        ...
        if (_ = U(c % m), c === u ? (f = this._repeat, _ = l) : (g = U(c / m), f = ~~g, f && f === g && (_ = l, f--), _ > l && (_ = l)), g = Jt(this._tTime, m), !a && this._tTime && g !== f && this._tTime - g * m - this._dur <= 0 && (g = f), T && f & 1 && (_ = l - _, S = 1), f !== g && !this._lock) {
          ...
          if (f < g && (k = !k), a = k ? 0 : c % l ? l : c, this._lock = 1, this.render(a || (S ? 0 : U(f * m)), n, !l)._lock = 0, this._tTime = c, !n && this.parent && rt(this, "onRepeat"), this.vars.repeatRefresh && !S && (this.invalidate()._lock = 1), a && a !== this._time || y !== !this._ts || this.vars.onRepeat && !this.parent && !this._act)
            return this;
          if (l = this._dur, u = this._tDur, x && (this._lock = 2, a = k ? l : -1e-4, this.render(a, !0), this.vars.repeatRefresh && !S && this.invalidate()), this._lock = 0, !this._ts && !y)
            return this;
          Er(this, S);
        }
      }
      if (this._hasPause && !this._forcing && this._lock < 2 && (v = gn(this, U(a), U(_)), v && (c -= _ - (_ = v._start))), this._tTime = c, this._time = _, this._act = !w, this._initted || (this._onUpdate = this.vars.onUpdate, this._initted = 1, this._zTime = r, a = 0), !a && c && !n && !g && (rt(this, "onStart"), this._tTime !== c))
        return this;
      if (_ >= a && r >= 0)
        for (d = this._first; d; ) {
        ...
        for (var M = r < 0 ? r : _; d; ) {
          if (p = d._prev, (d._act || M <= d._end) && d._ts && v !== d) {
            if (d.parent !== this)
              return this.render(r, n, s);
            if (d.render(d._ts > 0 ? (M - d._start) * d._ts : (d._dirty ? d.totalDuration() : d._tDur) + (M - d._start) * d._ts, n, s || X && wi(d)), _ !== this._time || !this._ts && !y) {
      ...
      if (v && !n && (this.pause(), v.render(_ >= a ? 0 : -P)._zTime = _ >= a ? 1 : -1, this._ts))
        return this._start = b, Fe(this), this.render(r, n, s);
      this._onUpdate && !n && rt(this, "onUpdate", !0), (c === u && this._tTime >= this.totalDuration() || !c && a) && (b === this._start || Math.abs(w) !== Math.abs(this._ts)) && (this._lock || ((r || !l) && (c === u && this._ts > 0 || !c && this._ts < 0) && Et(this, 1), !n && !(r < 0 && !a) && (c || a || !u) && (rt(this, c === u && r >= 0 ? "onComplete" : "onReverseComplete", !0), this._prom && !(c < u && this.timeScale() > 0) && this._prom())));
    }
    return this;
  }, e.add = function(r, n) {
    var s = this;
    if (bt(n) || (n = at(this, n, r)), !(r instanceof me)) {
      if (j(r))
    ...
    for (var s = [], a = lt(r), u = this._first, l = bt(n), c; u; )
      u instanceof B ? cn(u._targets, a) && (l ? (!Tt || u._initted && u._ts) && u.globalTime(0) <= n && u.globalTime(u.totalDuration()) > n : !n || u.isActive()) && s.push(u) : (c = u.getTweensOf(a, n)).length && s.push.apply(s, c), u = u._next;
    return s;
    ...
    if (I._ts && (cr(I, Ae(r, I)), ur = it.frame), it.frame >= Li) {
      Li += nt.autoSleep || 120;
      var n = I._first;
...
var Rn = function(t, e, i, r, n, s, a) {
  var u = new Q(this._pt, t, e, 0, 1, qr, null, n), l = 0, c = 0, h, _, d, p, f, m, y, v;
  ...
  return u.c = l < r.length ? r.substring(l, r.length) : "", u.fp = a, (rr.test(r) || y) && (u.e = 0), this._pt = u, u;
}, bi = function(t, e, i, r, n, s, a, u, l, c) {
  z(r) && (r = r(n || 0, t, s));
  var h = t[e], _ = i !== "get" ? i : z(h) ? l ? t[e.indexOf("set") || !z(t["get" + e.substr(3)]) ? e : "get" + e.substr(3)](l) : t[e]() : h, d = z(h) ? l ? qn : Fr : Ti, p;
  if (G(r) && (~r.indexOf("random(") && (r = de(r)), r.charAt(1) === "=" && (p = jt(_, r) + ($(_) || 0), (p || p === 0) && (r = p))), !c || _ !== r || ii)
    return !isNaN(_ * r) && r !== "" ? (p = new Q(this._pt, t, e, +_ || 0, r - (_ || 0), typeof h == "boolean" ? Bn : zr, 0, d), l && (p.fp = l), a && p.modifier(a, this, t), this._pt = p) : (!h && !(e in t) && mi(e, r), Rn.call(this, t, e, _, r, d, u || nt.stringFilter, l));
}, Ln = function(t, e, i, r, n) {
  if (z(t) && (t = fe(t, n, e, i, r)), !mt(t) || t.style && t.nodeType || j(t) || er(t))
  ...
  var a, u, l, c;
  if (et[t] && (a = new et[t]()).init(n, a.rawVars ? e[t] : Ln(e[t], r, n, s, i), i, r, s) !== !1 && (i._pt = u = new Q(i._pt, n, t, 0, 1, a.render, a, 0, a.priority), i !== $t))
    for (l = i._ptLookup[i._targets.indexOf(n)], c = a._props.length; c--; )
      l[a._props[c]] = u;
  return a;
}, Tt, ii, xi = function o(t, e, i) {
  var r = t.vars, n = r.ease, s = r.startAt, a = r.immediateRender, u = r.lazy, l = r.onUpdate, c = r.runBackwards, h = r.yoyoEase, _ = r.keyframes, d = r.autoRevert, p = t._dur, f = t._startAt, m = t._targets, y = t.parent, v = y && y.data === "nested" ? y.vars.targets : m, w = t._overwrite === "auto" && !hi, b = t.timeline, g, T, S, k, x, M, D, E, A, Y, V, N, W;
  if (b && (!_ || !n) && (n = "none"), t._ease = Ut(n, Zt.ease), t._yEase = h ? Pr(Ut(h === !0 ? n : h, Zt.ease)) : 0, h && t._yoyo && !t._repeat && (h = t._yEase, t._yEase = t._ease, t._ease = h), t._from = !b && !!r.runBackwards, !b || _ && !r.stagger) {
    if (E = m[0] ? Nt(m[0]).harness : 0, N = E && r[E.prop], g = Ee(r, gi), f && (f._zTime < 0 && f.progress(1), e < 0 && c && a && !d ? f.render(-1, !0) : f.revert(c && p ? Se : un), f._lazy = 0), s) {
    ...
    for (t._pt = t._ptCache = 0, u = p && H(u) || u && !p, T = 0; T < m.length; T++) {
      if (x = m[T], D = x._gsap || vi(m)[T]._gsap, t._ptLookup[T] = Y = {}, He[D.id] && Ot.length && Pe(), V = v === m ? T : v.indexOf(x), E && (A = new E()).init(x, N || g, t, V, v) !== !1 && (t._pt = k = new Q(t._pt, x, A.name, 0, 1, A.render, A, 0, A.priority), A._props.forEach(function(ft) {
        Y[ft] = k;
      }), A.priority && (M = 1)), !E || N)
        for (S in g)
          et[S] && (A = Rr(S, g, t, V, x, v)) ? A.priority && (M = 1) : Y[S] = k = bi.call(t, x, S, "get", g[S], V, v, 0, r.stringFilter);
      t._op && t._op[T] && t.kill(x, t._op[T]), w && t._pt && (Tt = t, I.killTweensOf(x, Y, t.globalTime(e)), W = !t.parent, Tt = 0), t._pt && u && (He[D.id] = 1);
    }
    M && Nr(t), t._onInit && t._onInit(t);
  }
  t._onUpdate = l, t._initted = (!t._op || t._pt) && !W, _ && e <= 0 && b.render(ut, !0, !0);
}, In = function(t, e, i, r, n, s, a, u) {
    ...
    for (l = t._ptCache[e] = [], _ = t._ptLookup, d = t._targets.length; d--; ) {
      if (c = _[d][e], c && c.d && c.d._pt)
        for (c = c.d._pt; c && c.p !== e && c.fp !== e; )
          c = c._next;
      if (!c)
        return ii = 1, t.vars[e] = "+=0", xi(t, a), ii = 0, u ? he(e + " not eligible for reset") : 1;
      l.push(c);
    }
  for (d = l.length; d--; )
...
}, Lr = yi + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,autoRevert", Ir = {};
Z(Lr + ",id,stagger,delay,duration,paused,scrollTrigger", function(o) {
  return Ir[o] = 1;
});
var B = /* @__PURE__ */ function(o) {
  ...
  function t(i, r, n, s) {
    ...
    var u = a.vars, l = u.duration, c = u.delay, h = u.immediateRender, _ = u.stagger, d = u.overwrite, p = u.keyframes, f = u.defaults, m = u.scrollTrigger, y = u.yoyoEase, v = r.parent || I, w = (j(i) || er(i) ? bt(i[0]) : "length" in r) ? [i] : lt(i), b, g, T, S, k, x, M, D;
    if (a._targets = w.length ? vi(w) : he("GSAP target " + i + " not found. https://gsap.com", !nt.nullTargetWarn) || [], a._ptLookup = [], a._overwrite = d, p || _ || xe(l) || xe(c)) {
      if (r = a.vars, b = a.timeline = new K({
        data: "nested",
        defaults: f || {},
        targets: v && v.data === "nested" ? v.vars.targets : w
      }), b.kill(), b.parent = b._dp = yt(a), b._start = 0, _ || xe(l) || xe(c)) {
        if (S = w.length, M = _ && vr(_), mt(_))
          for (k in _)
            ~Lr.indexOf(k) && (D || (D = {}), D[k] = _[k]);
        for (g = 0; g < S; g++)
          T = Ee(r, Ir), T.stagger = 0, y && (T.yoyoEase = y), D && Qt(T, D), x = w[g], T.duration = +fe(l, yt(a), g, x, w), T.delay = (+fe(c, yt(a), g, x, w) || 0) - a._delay, !_ && S === 1 && T.delay && (a._delay = c = T.delay, a._start += c, T.delay = 0), b.to(x, T, M ? M(g, x, w) : 0), b._ease = O.none;
        b.duration() ? l = c = 0 : a.timeline = 0;
      } else if (p) {
        le(ot(b.vars.defaults, {
          ease: "none"
        })), b._ease = Ut(p.ease || r.ease || "none");
        var E = 0, A, Y, V;
        if (j(p))
          ...
          T = {};
          for (k in p)
            k === "ease" || k === "easeEach" || zn(k, p[k], T, p.easeEach);
          for (k in T)
            for (A = T[k].sort(function(N, W) {
              ...
              }, V[k] = Y.v, b.to(w, V, E), E += V.duration;
          b.duration() < l && b.to({}, {
      ...
      a.timeline = 0;
    return d === !0 && !hi && (Tt = yt(a), I.killTweensOf(w), Tt = 0), dt(v, yt(a), n), r.reversed && a.reverse(), r.paused && a.paused(!0), (h || !l && !p && a._start === U(v._time) && H(h) && dn(yt(a)) && v.data !== "nested") && (a._tTime = -P, a.render(Math.max(0, -c) || 0)), m && pr(yt(a), m), a;
  }
  var e = t.prototype;
  return e.render = function(r, n, s) {
    var a = this._time, u = this._tDur, l = this._dur, c = r < 0, h = r > u - P && !c ? u : r < P ? 0 : r, _, d, p, f, m, y, v, w, b;
    if (!l)
      mn(this, r, n, s);
      ...
      if (_ = h, w = this.timeline, this._repeat) {
        ...
        if (_ = U(h % f), h === u ? (p = this._repeat, _ = l) : (m = U(h / f), p = ~~m, p && p === m ? (_ = l, p--) : _ > l && (_ = l)), y = this._yoyo && p & 1, y && (b = this._yEase, _ = l - _), m = Jt(this._tTime, f), _ === a && !s && this._initted && p === m)
          return this._tTime = h, this;
        p !== m && (w && this._yEase && Er(w, y), this.vars.repeatRefresh && !y && !this._lock && _ !== f && this._initted && (this._lock = s = 1, this.render(U(f * p), !0).invalidate()._lock = 0));
      }
      if (!this._initted) {
        if (mr(this, c ? r : _, s, n, h))
      ...
      if (this._tTime = h, this._time = _, !this._act && this._ts && (this._act = 1, this._lazy = 0), this.ratio = v = (b || this._ease)(_ / l), this._from && (this.ratio = v = 1 - v), !a && h && !n && !m && (rt(this, "onStart"), this._tTime !== h))
        return this;
      for (d = this._pt; d; )
        d.r(v, d.d), d = d._next;
    ...
    return this._initted || xi(this, l), c = this._ease(l / this._dur), In(this, r, n, s, a, c, l, u) ? this.resetTo(r, n, s, a, 1) : (ze(this, 0), this.parent || _r(this._dp, this, "_first", "_last", this._dp._sort ? "_start" : 0), this.render(0));
  }, e.kill = function(r, n) {
...
var Ti = function(t, e, i) {
  ...
  return z(t[e]) ? Fr : _i(t[e]) && t.setAttribute ? Nn : Ti;
}, zr = function(t, e) {
  ...
  function o(e, i, r, n, s, a, u, l, c) {
    this.t = i, this.s = n, this.c = s, this.p = r, this.r = a || zr, this.d = u || this, this.set = l || Ti, this.pr = c || 0, this._next = e, e && (e._prev = this);
  }
  var t = o.prototype;
...
nt.stringFilter = Cr;
var Vt = [], Oe = {}, Gn = [], Bi = 0, Yn = 0, We = function(t) {
  return (Oe[t] || Gn).map(function(e) {
    return e();
  });
}, ri = function() {
  var t = Date.now(), e = [];
  ...
  function o(e, i) {
    this.selector = i && ti(i), this.data = [], this._r = [], this.isReverted = !1, this.id = Yn++, e && this.add(e);
  }
  var t = o.prototype;
  ...
  return t.add = function(i, r, n) {
    ...
    var s = new Br(0, n || this.scope), a = s.conditions = {}, u, l, c;
...
var $n = function(t, e) {
  ...
  for (r in e)
    for (n = i.length; n--; )
      s = t._ptLookup[n][r], s && (s = s.d) && (s._pt && (s = $n(s, r)), s && s.modifier && s.modifier(e[r], t, i[n], r));
}, Ge = function(t, e) {
  return {
    name: t,
    headless: 1,
...
}, Ge("roundProps", ei), Ge("modifiers"), Ge("snap", wr)) || De;
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
var Ui, St, Kt, Oi, qt, Vi, Mi, Kn = function() {
  return typeof window < "u";
}, xt = {}, zt = 180 / Math.PI, Ht = Math.PI / 180, Yt = Math.atan2, Wi = 1e8, Ci = /([A-Z])/g, Hn = /(left|right|width|margin|padding|x)/i, Zn = /[\s,\(]\S/, pt = {
...
}, F = "transform", J = F + "Origin", as = function o(t, e) {
  ...
  if (this.tfm) {
    for (s in this.tfm)
      r[s] = this.tfm[s];
    r.svg && (r.renderTransform(), e.setAttribute("data-svg-origin", this.svgo || "")), n = Mi(), (!n || !n.isStart) && !i[F] && (Wr(i), r.zOrigin && i[J] && (i[J] += " " + r.zOrigin + "px", r.zOrigin = 0, r.renderTransform()), r.uncache = 1);
  }
}, Gr = function(t, e) {
  var i = {
    target: t,
  ...
  return r[e] || r.getPropertyValue(e.replace(Ci, "-$1").toLowerCase()) || r.getPropertyValue(e) || !i && o(t, ie(e) || e, 1) || "";
  ...
  Kn() && window.document && (Ui = window, St = Ui.document, Kt = St.documentElement, qt = si("div") || {
    style: {}
  }, si("div"), F = ie(F), J = F + "Origin", qt.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0", Yr = !!ie("perspective"), Mi = tt.core.reverting, Oi = 1);
}, Yi = function(t) {
  ...
  if (e) {
    var i = t.style, r;
    e in xt && e !== J && (e = F), i.removeProperty ? (r = e.substr(0, 2), (r === "ms" || e.substr(0, 6) === "webkit") && (e = "-" + e), i.removeProperty(r === "--" ? e : e.replace(Ci, "-$1").toLowerCase())) : i.removeAttribute(e);
  }
}, kt = function(t, e, i, r, n, s) {
  var a = new Q(t._pt, e, i, 0, 1, s ? Vr : Ur);
  ...
  var n = parseFloat(i) || 0, s = (i + "").trim().substr((n + "").length) || "px", a = qt.style, u = Hn.test(e), l = t.tagName.toLowerCase() === "svg", c = (l ? "client" : "offset") + (u ? "Width" : "Height"), h = 100, _ = r === "px", d = r === "%", p, f, m, y;
  if (r === s || !n || $i[r] || $i[s])
    return n;
  if (s !== "px" && !_ && (n = o(t, e, i, "px")), y = t.getCTM && $r(t), (d || s === "%") && (xt[e] || ~e.indexOf("adius")))
  ...
  if (d && (e === "height" || e === "width")) {
    ...
    (d || s === "%") && !ls[ct(f, "display")] && (a.position = ct(t, "position")), f === t && (a.position = "static"), f.appendChild(qt), p = qt[c], f.removeChild(qt), a.position = "absolute";
  return u && d && (m = Nt(f), m.time = it.time, m.width = f[c]), q(_ ? p * n / h : p && n ? h / p * n : 0);
}, vt = function(t, e, i, r) {
  var n;
  return Oi || oi(), e in pt && e !== "transform" && (e = pt[e], ~e.indexOf(",") && (e = e.split(",")[0])), xt[e] && e !== "transform" ? (n = ye(t, r), n = e !== "transformOrigin" ? n[e] : n.svg ? n.origin : Le(ct(t, J)) + " " + n.zOrigin + "px") : (n = t.style[e], (!n || n === "auto" || r || ~(n + "").indexOf("calc(")) && (n = Re[e] && Re[e](t, e, i) || ct(t, e) || lr(t, e) || (e === "opacity" ? 1 : 0))), i && !~(n + "").trim().indexOf(" ") ? At(t, e, n, i) + i : n;
}, cs = function(t, e, i, r) {
  if (!i || i === "none") {
    var n = ie(e, t, 1), s = n && ct(t, n, 1);
    s && s !== i ? (e = n, i = s) : e === "borderColor" && (i = ct(t, "borderTopColor"));
  }
  var a = new Q(this._pt, t.style, e, 0, 1, qr), u = 0, l = 0, c, h, _, d, p, f, m, y, v, w, b, g;
  if (a.b = i, a.e = r, i += "", r += "", r.substring(0, 6) === "var(--" && (r = ct(t, r.substring(4, r.indexOf(")")))), r === "auto" && (f = t.style[e], t.style[e] = r, r = ct(t, e) || r, f ? t.style[e] = f : Wt(t, e)), c = [i, r], Cr(c), i = c[0], r = c[1], _ = i.match(Xt) || [], g = r.match(Xt) || [], g.length) {
    for (; h = Xt.exec(r); )
      m = h[0], v = r.substring(u, h.index), p ? p = (p + 1) % 5 : (v.substr(-5) === "rgba(" || v.substr(-5) === "hsla(") && (p = 1), m !== (f = _[l++] || "") && (d = parseFloat(f) || 0, b = f.substr((d + "").length), m.charAt(1) === "=" && (m = jt(d, m) + b), y = parseFloat(m), w = m.substr((y + "").length), u = Xt.lastIndex - w.length, w || (w = w || nt.units[e] || b, u === r.length && (r += w, a.e += w)), b !== w && (d = At(t, e, f, w) || 0), a._pt = {
        _next: a._pt,
        p: v || l === 1 ? v : ",",
        //note: SVG spec allows omission of comma/space when a negative sign is wedged between two numbers, like 2.5-5.3 instead of 2.5,-5.3 but when tweening, the negative value may switch to positive, so we insert the comma just in case.
        s: d,
    ...
    a.r = e === "display" && r === "none" ? Vr : Ur;
  return rr.test(r) && (a.e = 0), this._pt = a, a;
}, ji = {
  top: "0%",
  bottom: "100%",
  left: "0%",
  ...
  if (e.tween && e.tween._time === e.tween._dur) {
    ...
    if (n === "all" || n === !0)
      ...
      for (n = n.split(","), l = n.length; --l > -1; )
        a = n[l], xt[a] && (u = 1, a = a === "transformOrigin" ? J : F), Wt(i, a);
    u && (Wt(i, F), s && (s.svg && i.removeAttribute("transform"), r.scale = r.rotate = r.translate = "none", ye(i, 1), s.uncache = 1, Wr(r)));
  }
}, Re = {
  clearProps: function(t, e, i, r, n) {
    if (n.data !== "isFromStart") {
      var s = t._pt = new Q(t._pt, e, i, 0, 0, hs);
  ...
  */
}, ge = [1, 0, 0, 1, 0, 0], jr = {}, Kr = function(t) {
  return t === "matrix(1, 0, 0, 1, 0, 0)" || t === "none" || !t;
}, Ki = function(t) {
  var e = ct(t, F);
  return Kr(e) ? ge : e.substr(7).match(ir).map(q);
}, Pi = function(t, e) {
  ...
  var a = t._gsap, u = n || Pi(t, !0), l = a.xOrigin || 0, c = a.yOrigin || 0, h = a.xOffset || 0, _ = a.yOffset || 0, d = u[0], p = u[1], f = u[2], m = u[3], y = u[4], v = u[5], w = e.split(" "), b = parseFloat(w[0]) || 0, g = parseFloat(w[1]) || 0, T, S, k, x;
  i ? u !== ge && (S = d * m - p * f) && (k = b * (m / S) + g * (-f / S) + (f * v - m * y) / S, x = b * (-p / S) + g * (d / S) - (d * v - p * y) / S, b = k, g = x) : (T = Xr(t), b = T.x + (~w[0].indexOf("%") ? b / 100 * T.width : b), g = T.y + (~(w[1] || w[0]).indexOf("%") ? g / 100 * T.height : g)), r || r !== !1 && a.smooth ? (y = b - l, v = g - c, a.xOffset = h + (y * d + v * f) - y, a.yOffset = _ + (y * p + v * m) - v) : a.xOffset = a.yOffset = 0, a.xOrigin = b, a.yOrigin = g, a.smooth = !!r, a.origin = e, a.originIsAbsolute = !!i, t.style[J] = "0px 0px", s && (kt(s, a, "xOrigin", l, b), kt(s, a, "yOrigin", c, g), kt(s, a, "xOffset", h, a.xOffset), kt(s, a, "yOffset", _, a.yOffset)), t.setAttribute("data-svg-origin", b + " " + g);
}, ye = function(t, e) {
  var i = t._gsap || new Dr(t);
  if ("x" in i && !e && !i.uncache)
    return i;
  var r = t.style, n = i.scaleX < 0, s = "px", a = "deg", u = getComputedStyle(t), l = ct(t, J) || "0", c, h, _, d, p, f, m, y, v, w, b, g, T, S, k, x, M, D, E, A, Y, V, N, W, ft, be, re, ne, Rt, Ri, gt, Lt;
  return c = h = _ = f = m = y = v = w = b = 0, d = p = 1, i.svg = !!(t.getCTM && $r(t)), u.translate && ((u.translate !== "none" || u.scale !== "none" || u.rotate !== "none") && (r[F] = (u.translate !== "none" ? "translate3d(" + (u.translate + " 0 0").split(" ").slice(0, 3).join(", ") + ") " : "") + (u.rotate !== "none" ? "rotate(" + u.rotate + ") " : "") + (u.scale !== "none" ? "scale(" + u.scale.split(" ").join(",") + ") " : "") + (u[F] !== "none" ? u[F] : "")), r.scale = r.rotate = r.translate = "none"), S = Pi(t, i.svg), i.svg && (i.uncache ? (ft = t.getBBox(), l = i.xOrigin - ft.x + "px " + (i.yOrigin - ft.y) + "px", W = "") : W = !e && t.getAttribute("data-svg-origin"), ai(t, W || l, !!W || i.originIsAbsolute, i.smooth !== !1, S)), g = i.xOrigin || 0, T = i.yOrigin || 0, S !== ge && (D = S[0], E = S[1], A = S[2], Y = S[3], c = V = S[4], h = N = S[5], S.length === 6 ? (d = Math.sqrt(D * D + E * E), p = Math.sqrt(Y * Y + A * A), f = D || E ? Yt(E, D) * zt : 0, v = A || Y ? Yt(A, Y) * zt + f : 0, v && (p *= Math.abs(Math.cos(v * Ht))), i.svg && (c -= g - (g * D + T * A), h -= T - (g * E + T * Y))) : (Lt = S[6], Ri = S[7], re = S[8], ne = S[9], Rt = S[10], gt = S[11], c = S[12], h = S[13], _ = S[14], k = Yt(Lt, Rt), m = k * zt, k && (x = Math.cos(-k), M = Math.sin(-k), W = V * x + re * M, ft = N * x + ne * M, be = Lt * x + Rt * M, re = V * -M + re * x, ne = N * -M + ne * x, Rt = Lt * -M + Rt * x, gt = Ri * -M + gt * x, V = W, N = ft, Lt = be), k = Yt(-A, Rt), y = k * zt, k && (x = Math.cos(-k), M = Math.sin(-k), W = D * x - re * M, ft = E * x - ne * M, be = A * x - Rt * M, gt = Y * M + gt * x, D = W, E = ft, A = be), k = Yt(E, D), f = k * zt, k && (x = Math.cos(k), M = Math.sin(k), W = D * x + E * M, ft = V * x + N * M, E = E * x - D * M, N = N * x - V * M, D = W, V = ft), m && Math.abs(m) + Math.abs(f) > 359.9 && (m = f = 0, y = 180 - y), d = q(Math.sqrt(D * D + E * E + A * A)), p = q(Math.sqrt(N * N + Lt * Lt)), k = Yt(V, N), v = Math.abs(k) > 2e-4 ? k * zt : 0, b = gt ? 1 / (gt < 0 ? -gt : gt) : 0), i.svg && (W = t.getAttribute("transform"), i.forceCSS = t.setAttribute("transform", "") || !Kr(ct(t, F)), W && t.setAttribute("transform", W))), Math.abs(v) > 90 && Math.abs(v) < 270 && (n ? (d *= -1, v += f <= 0 ? 180 : -180, f += f <= 0 ? 180 : -180) : (p *= -1, v += v <= 0 ? 180 : -180)), e = e || i.uncache, i.x = c - ((i.xPercent = c && (!e && i.xPercent || (Math.round(t.offsetWidth / 2) === Math.round(-c) ? -50 : 0))) ? t.offsetWidth * i.xPercent / 100 : 0) + s, i.y = h - ((i.yPercent = h && (!e && i.yPercent || (Math.round(t.offsetHeight / 2) === Math.round(-h) ? -50 : 0))) ? t.offsetHeight * i.yPercent / 100 : 0) + s, i.z = _ + s, i.scaleX = q(d), i.scaleY = q(p), i.rotation = q(f) + a, i.rotationX = q(m) + a, i.rotationY = q(y) + a, i.skewX = v + a, i.skewY = w + a, i.transformPerspective = b + s, (i.zOrigin = parseFloat(l.split(" ")[2]) || !e && i.zOrigin || 0) && (r[J] = Le(l)), i.xOffset = i.yOffset = 0, i.force3D = nt.force3D, i.renderTransform = i.svg ? ds : Yr ? Hr : _s, i.uncache = 0, i;
}, Le = function(t) {
...
}, It = "0deg", se = "0px", Ft = ") ", Hr = function(t, e) {
  var i = e || this, r = i.xPercent, n = i.yPercent, s = i.x, a = i.y, u = i.z, l = i.rotation, c = i.rotationY, h = i.rotationX, _ = i.skewX, d = i.skewY, p = i.scaleX, f = i.scaleY, m = i.transformPerspective, y = i.force3D, v = i.target, w = i.zOrigin, b = "", g = y === "auto" && t && t !== 1 || y === !0;
  if (w && (h !== It || c !== It)) {
    var T = parseFloat(c) * Ht, S = Math.sin(T), k = Math.cos(T), x;
    T = parseFloat(h) * Ht, x = Math.cos(T), s = Ye(v, s, S * x * -w), a = Ye(v, a, -Math.sin(T) * -w), u = Ye(v, u, k * x * -w + w);
  }
  m !== se && (b += "perspective(" + m + Ft), (r || n) && (b += "translate(" + r + "%, " + n + "%) "), (g || s !== se || a !== se || u !== se) && (b += u !== se || g ? "translate3d(" + s + ", " + a + ", " + u + ") " : "translate(" + s + ", " + a + Ft), l !== It && (b += "rotate(" + l + Ft), c !== It && (b += "rotateY(" + c + Ft), h !== It && (b += "rotateX(" + h + Ft), (_ !== It || d !== It) && (b += "skew(" + _ + ", " + d + Ft), (p !== 1 || f !== 1) && (b += "scale(" + p + ", " + f + Ft), v.style[F] = b || "translate(0, 0)";
}, ds = function(t, e) {
  var i = e || this, r = i.xPercent, n = i.yPercent, s = i.x, a = i.y, u = i.rotation, l = i.skewX, c = i.skewY, h = i.scaleX, _ = i.scaleY, d = i.target, p = i.xOrigin, f = i.yOrigin, m = i.xOffset, y = i.yOffset, v = i.forceCSS, w = parseFloat(s), b = parseFloat(a), g, T, S, k, x;
  u = parseFloat(u), l = parseFloat(l), c = parseFloat(c), c && (c = parseFloat(c), l += c, u += c), u || l ? (u *= Ht, l *= Ht, g = Math.cos(u) * h, T = Math.sin(u) * h, S = Math.sin(u - l) * -_, k = Math.cos(u - l) * _, l && (c *= Ht, x = Math.tan(l - c), x = Math.sqrt(1 + x * x), S *= x, k *= x, c && (x = Math.tan(c), x = Math.sqrt(1 + x * x), g *= x, T *= x)), g = q(g), T = q(T), S = q(S), k = q(k)) : (g = h, k = _, T = S = 0), (w && !~(s + "").indexOf("px") || b && !~(a + "").indexOf("px")) && (w = At(d, "x", s, "px"), b = At(d, "y", a, "px")), (p || f || m || y) && (w = q(w + p - (p * g + f * S) + m), b = q(b + f - (p * T + f * k) + y)), (r || n) && (x = d.getBBox(), w = q(w + r / 100 * x.width), b = q(b + n / 100 * x.height)), x = "matrix(" + g + "," + T + "," + S + "," + k + "," + w + "," + b + ")", d.setAttribute("transform", x), v && (d.style[F] = x);
}, ps = function(t, e, i, r, n) {
  var s = 360, a = G(n), u = parseFloat(n) * (a && ~n.indexOf("rad") ? zt : 1), l = u - r, c = r + l + "deg", h, _;
  return a && (h = n.split("_")[1], h === "short" && (l %= s, l !== l % (s / 2) && (l += l < 0 ? s : -s)), h === "cw" && l < 0 ? l = (l + s * Wi) % s - ~~(l / s) * s : h === "ccw" && l > 0 && (l = (l - s * Wi) % s - ~~(l / s) * s)), t._pt = _ = new Q(t._pt, e, i, r, l, Qn), _.e = c, _.u = "deg", t._props.push(i), _;
}, Hi = function(t, e) {
  for (var i in e)
    t[i] = e[i];
  return t;
...
var Zr = {
  ...
  init: function(t, e, i, r, n) {
    var s = this._props, a = t.style, u = i.vars.startAt, l, c, h, _, d, p, f, m, y, v, w, b, g, T, S, k;
    Oi || oi(), this.styles = this.styles || Gr(t), k = this.styles.props, this.tween = i;
    for (f in e)
      if (f !== "autoRound" && (c = e[f], !(et[f] && Rr(f, e, i, r, t, n)))) {
        if (d = typeof c, p = Re[f], d === "function" && (c = c.call(i, r, t, n), d = typeof c), d === "string" && ~c.indexOf("random(") && (c = de(c)), p)
          p(this, t, f, c, i) && (S = 1);
        else if (f.substr(0, 2) === "--")
          l = (getComputedStyle(t).getPropertyValue(f) + "").trim(), c += "", Mt.lastIndex = 0, Mt.test(l) || (m = $(l), y = $(c)), y ? m !== y && (l = At(t, f, l, y) + y) : m && (c += m), this.add(a, "setProperty", l, c, r, n, 0, 0, f), s.push(f), k.push(f, 0, a[f]);
        else if (d !== "undefined") {
          if (u && f in u ? (l = typeof u[f] == "function" ? u[f].call(i, r, t, n) : u[f], G(l) && ~l.indexOf("random(") && (l = de(l)), $(l + "") || l === "auto" || (l += nt.units[f] || $(vt(t, f)) || ""), (l + "").charAt(1) === "=" && (l = vt(t, f))) : l = vt(t, f), _ = parseFloat(l), v = d === "string" && c.charAt(1) === "=" && c.substr(0, 2), v && (c = c.substr(2)), h = parseFloat(c), f in pt && (f === "autoAlpha" && (_ === 1 && vt(t, "visibility") === "hidden" && h && (_ = 0), k.push("visibility", 0, a.visibility), kt(this, a, "visibility", _ ? "inherit" : "hidden", h ? "inherit" : "hidden", !h)), f !== "scale" && f !== "transform" && (f = pt[f], ~f.indexOf(",") && (f = f.split(",")[0]))), w = f in xt, w) {
            if (this.styles.save(f), d === "string" && c.substring(0, 6) === "var(--" && (c = ct(t, c.substring(4, c.indexOf(")"))), h = parseFloat(c)), b || (g = t._gsap, g.renderTransform && !e.parseTransform || ye(t, e.parseTransform), T = e.smoothOrigin !== !1 && g.smooth, b = this._pt = new Q(this._pt, a, F, 0, 1, g.renderTransform, g, 0, -1), b.dep = 1), f === "scale")
              this._pt = new Q(this._pt, g, "scaleY", g.scaleY, (v ? jt(g.scaleY, v + h) : h) - g.scaleY || 0, ni), this._pt.u = 0, s.push("scaleY", f), f += "X";
            else if (f === "transformOrigin") {
              k.push(J, 0, a[J]), c = fs(c), g.svg ? ai(t, c, 0, T, 0, this) : (y = parseFloat(c.split(" ")[2]) || 0, y !== g.zOrigin && kt(this, g, "zOrigin", g.zOrigin, y), kt(this, a, f, Le(l), Le(c)));
              continue;
            } else if (f === "svgOrigin") {
              ai(t, c, 1, T, 0, this);
              continue;
            } else if (f in jr) {
              ps(this, g, f, _, v ? jt(_, v + c) : c);
              continue;
          ...
          if (w || (h || h === 0) && (_ || _ === 0) && !Zn.test(c) && f in a)
            m = (l + "").substr((_ + "").length), h || (h = 0), y = $(c) || (f in nt.units ? nt.units[f] : m), m !== y && (_ = At(t, f, l, y)), this._pt = new Q(this._pt, w ? g : a, f, _, (v ? jt(_, v + h) : h) - _, !w && (y === "px" || f === "zIndex") && e.autoRound !== !1 ? ts : ni), this._pt.u = y || 0, m !== y && y !== "%" && (this._pt.b = l, this._pt.r = Jn);
          else if (f in a)
            cs.call(this, t, f, l, v ? v + c : c);
          else if (f in t)
  ...
  getSetter: function(t, e, i) {
    var r = pt[e];
    return r && r.indexOf(",") < 0 && (e = r), e in xt && e !== J && (t._gsap.x || vt(t, "x")) ? i && Vi === i ? e === "scale" ? ns : rs : (Vi = i || {}) && (e === "scale" ? ss : os) : t.style && !_i(t.style[e]) ? es : ~e.indexOf("-") ? is : Si(t, e);
  },
  core: {
    _removeProperty: Wt,
    _getMatrix: Pi
...
tt.registerPlugin(Zr);
var L = tt.registerPlugin(Zr) || tt;
L.core.Tween;
const ve = {
  fadeOutDuration: 0.4,
  fadeInDuration: 0.3,
...
function gs() {
  ...
  return console.log("🔍 Éléments trouvés:", {
  ...
  }), Me = !1, Promise.resolve(null)) : (console.log("🎨 Configuration des styles initiaux"), L.set(o, {
    opacity: 1,
    display: "flex",
    ...
    delay: 0.1,
    ease: ve.ease
  }), bs(), Me = !0, console.log("✅ Écran de chargement initialisé avec succès"), Promise.resolve(o));
}
function ys() {
...
function bs() {
  document.addEventListener("click", (o) => {
    ...
    !e || e.startsWith("#") || e.startsWith("http") || i === "_blank" || e.startsWith("mailto:") || e.startsWith("tel:") || (o.preventDefault(), ws(() => {
...
function ci(o, t = () => {
  ...
  wt = !0;
  const e = Ct, i = document.querySelector(e.containerSelector);
  document.body.classList.remove("scroll-lock"), o.classList.remove("is-open"), L.to(i, {
    opacity: 0,
    duration: 0.3,
    ease: "power2.inOut",
    onComplete: () => {
      i.classList.remove("is-open"), wt = !1, Ct = null, t && t();
    }
  });
}
function Cs(o, t) {
...
function Ps(o, t) {
  ...
  }), i = Ct && ((r = document.querySelector(Ct.containerSelector)) == null ? void 0 : r.contains(o.target));
  !e && !i && ci(t);
}
function Zi() {
  ...
  Qr.forEach((t) => {
    ...
    i.classList.remove("is-open"), L.set(i, { opacity: 0 }), e.addEventListener("click", (r) => {
      r.preventDefault(), r.stopPropagation(), !wt && (Ct === t ? ci(o) : ci(o, () => {
        Cs(t, o);
      }));
    });
  }), document.addEventListener("click", (t) => Ps(t, o)), console.log("✅ Menu desktop initialisé.");
}
let Xe = !1;
async function Qi(o, t) {
  ...
  if (!Xe) {
    ...
    try {
      if (o.classList.contains("is-open"))
        ...
        await Promise.all(Array.from(i).map((n) => Qi(n, t))), await Es(o, t);
...
function en() {
  setTimeout(typeof L < "u" ? tn : en, 100);
}
en();
...
function Vs() {
  document.querySelector(".desktop_menu_wrapper") ? (console.log("✅ Menu wrapper trouvé immédiatement. Initialisation..."), Zi()) : (console.log("⏳ Menu wrapper non trouvé. Mise en place d'un observateur..."), new MutationObserver((e, i) => {
    document.querySelector(".desktop_menu_wrapper") && (console.log("👀 L'observateur a détecté le menu wrapper. Initialisation..."), Zi(), i.disconnect());
...
async function Ws() {
  ...
  try {
    ...
    if (await Promise.all(t), console.log("✨ Tous les modules ont été initialisés"), document.getElementById("container-initial")) {
      ...
      try {
        const { SmileWorldReservation: i } = await import("./reservation-BOdxT1fr.mjs");
    ...
    console.error("❌ Erreur fatale lors de l'initialisation:", o), vs();
  }
}
window.Webflow = window.Webflow || [];
window.Webflow.push(Ws);
export {
  L as g
};
